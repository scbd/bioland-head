        ...
        <table class="table table-striped table-hover">
            <thead  >
                <tr  class="table-primary">
                    ...
                    <th scope="col" width="30%" @click="hideStatus[i]=!hideStatus[i]" >Status <LazyIcon v-if="!hideStatus[i]"  :size="2" name="eye" class="ms-5"/> <LazyIcon v-if="hideStatus[i]"   :size="2" name="eye-slash" class="ms-5"/></th>
            ...
            <tbody v-if="!hideRows[i]">
                <tr  v-for="(site,j) in section.sites || []" :key="j" :class="{'table-danger': dangerIndexes[i][j], 'table-warning': warnIndexes[i][j]}">
                    ...
                    <td>
                        ...
                        <br>
                        {{site.siteCode}}.chm-cbd.net
                    </td>
                    <td :class="{'table-success': successIndexes[i][j]}">
...
<script setup> 
    ...
    const hideRows       = ref([true,true,true,true]);
