          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer d-flex justify-content-center align-items-center mb-3">
                <NuxtLink :to="loginUri" type="button" class="btn btn-secondary mx-3 mb-2" external>{{t('Login')}}</NuxtLink>
                <NuxtLink :to="registerUri" type="button" class="btn btn-secondary mx-3 mb-2" external>{{t('Sign Up')}}</NuxtLink>
              </div>
            </div>
          </div>
    </VueFinalModal>
