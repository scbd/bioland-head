<template>
    <div>
        ...
        <LazyWidgetGbif              v-if="isGbif"/>
        <LazyWidgetELearning         v-if="isELearning"/>
        <LazyWidgetImplementation    v-if="isImplementation"/>
        <LazyWidgetTsc               v-if="isTsc"/> 
        <LazyWidgetForums            v-if="isForums"/>
        <LazyWidgetGeobon            v-if="isGeobon"/>
        <LazyWidgetContentTypesStats v-if="isContentTypesStats"/>
    </div>
</template>
<script setup>
...
const isContentTypesStats = computed(()=> is.value === 'contentTypesStats' || is.value?.includes('WidgetContentTypesStats'));
</script>
