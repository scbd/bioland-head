<template>
    <div v-if="isMobile" id="page-header-title-search-mobile" :class="{ 'mt-2': hasTempTopHeader, 'pt-1': hasTempTopHeader }" class="w-100 small-header position-fixed top-0 start-0 justify-content-start align-items-center  d-flex flex-row   d-md-none">
            ...
            <div id="page-header-title-search-mobile-brand" class="brand-small">
                <NuxtLink class="me-0 pe-0 navbar-brand-small fw-bold" :to="localePath(`/`)" >
                    {{name}}
                </NuxtLink>
        ...
        <div id="page-header-title-search-desktop-row" class=" navbar-header row align-items-center pe-3" :style="{ width: rowElWidth?`${rowElWidth+64}px`: '100%' }">
            <div id="page-header-title-search-desktop-brand-col" class="col-md-9 col-lg-9 d-flex  justify-content-start align-items-center">
                ...
                <span v-if="isBiosafetySite" id="page-header-title-search-desktop-biosafety-links" class="navbar-subbrand ps-2">
                    <NuxtLink class="navbar-subbrand text-nowrap" :class="{ hero: hasHeroImage }" to="https://bch.cbd.int/protocol" :aria-label="t('Secretariat of the Convention on Biological Diversity')"  >
                        <span class="w-500">{{t('Cartagena Protocol on Biosafety')}}</span>
                    </NuxtLink><br/>
                    <NuxtLink class="navbar-subbrand" :class="{ hero: hasHeroImage }" to="https://bch.cbd.int" :aria-label="t('Clearing House Mechanism')" >
        ...
        <div id="page-header-title-search-large-row" class=" navbar-header row align-items-center pe-3" :style="{ width: rowElWidth?`${rowElWidth+64}px`: '100%' }">
            <div id="page-header-title-search-large-brand-col" class="col-md-9 col-lg-9 d-flex  justify-content-start align-items-center">
                ...
                <span id="page-header-title-search-large-brand-links" class="navbar-subbrand ps-1">
                    <NuxtLink id="page-header-title-search-large-brand-home" class=" me-0 pe-0 navbar-brand "  :class="{ hero: hasHeroImage, 'fs-3':  name.length > 32 && name.length < 40  , 'fs-4':  name.length > 39}" :to="localePath(`/`)" >
                    {{name}}
                    </NuxtLink><br/>
            ...
            <div v-if="!pageStore.isSearch"  id="page-header-title-search-large-search-col" class=" col-md-3 col-lg-3 d-flex justify-content-end align-items-center" >
                <div id="page-header-title-search-large-search-box" class="input-group" :class="{ hero: hasHeroImage }" style="margin-left:2rem;margin-right:-2rem;">
                    ...
                    <button id="page-header-title-search-large-search-btn" type="button" v-on:click="onClick(queryText)" class="input-group-text"  :class="{ hero: hasHeroImage }"  :aria-label="t('Search this site')"  >
                        <LazyIcon name="search" class="white-icon" :class="{ hero: hasHeroImage }"/>&nbsp;
                    </button>
                </div>
            </div>
